...
namespace ManoTourism.Areas.Admin.Pages.ManageCompleteTransaction
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<JsonResult> OnPostAsync()
        {
            ...
            var recordsTotal = _context.CompleteTransactions.Count();

            var customersQuery = _context.CompleteTransactions.Select(i => new
            {
                CompleteTransactionId = i.CompleteTransactionId,
                TransactionTitleAr = i.TransactionTitleAr,
                TransactionTitleEn = i.TransactionTitleEn,
                Pic = i.Pic,
            ...
            if (!string.IsNullOrWhiteSpace(searchText))
            {
                customersQuery = customersQuery.Where(s =>
                    s.TransactionTitleAr.ToUpper().Contains(searchText) ||
                    s.TransactionTitleEn.ToUpper().Contains(searchText)
                );
            }
