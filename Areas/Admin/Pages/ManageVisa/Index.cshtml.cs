...
namespace ManoTourism.Areas.Admin.Pages.ManageVisa
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<JsonResult> OnPostAsync()
        {
                ...
                var recordsTotal = _context.Visas.Include(e => e.Country).Include(e => e.VisaType).Where(e => e.IsDeleted == false && e.VisaTargetId == 1).Count();

                var customersQuery = _context.Visas.Include(e => e.Country).Include(e => e.VisaType).Where(e => e.IsDeleted == false && e.VisaTargetId == 1).Select(i => new
                {
