...
namespace ManoTourism.Areas.Admin.Pages.Reports
{
    ...
    public class SellerReportModel : PageModel
    {
        ...
        public SellerReportModel(ManoContext context)
        {
            _context = context;
        }

        public ManoTourism.Report.SellerRptReport Report { get; set; }
        ...
        public IActionResult OnPost()
        {
            ...
            Report = new ManoTourism.Report.SellerRptReport(BrowserCulture);
            Report.DataSource = ds;
            return Page();
