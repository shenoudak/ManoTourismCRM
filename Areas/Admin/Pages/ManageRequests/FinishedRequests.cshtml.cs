...
namespace ManoTourism.Areas.Admin.Pages.ManageRequests
{
    ...
    public class FinishedRequestsModel : PageModel
    {
        ...
        public FinishedRequestsModel(ManoContext context, IToastNotification toastNotification, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        public async Task<JsonResult> OnPostAsync()
        {
            ...
            var recordsTotal = _context.Requests.Where(e => e.IsDeleted == false && e.VisaRequestStatusId == 3).Count();
            ...
            var customersQuery = _context.Requests.Include(e => e.Country).Include(e => e.VisaRequestStatus).Include(e => e.Nationality).Include(e => e.ManoEntityType).Include(e => e.CompanyMarkting).Where(e => e.IsDeleted == false && e.VisaRequestStatusId == 3).Select(i => new
            {
