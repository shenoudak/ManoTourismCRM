...
namespace ManoTourism.Areas.Admin.Pages.ManageRequests
{
    public class ProcessingRequestModel : PageModel
    {
        ...
        public ProcessingRequestModel(ManoContext context, IToastNotification toastNotification, UserManager<ApplicationUser> userManager)
        {
            _context = context;
            ...
            try
            {
                ...
                if (roleName.FirstOrDefault() == "admin" || roleName.FirstOrDefault() == "employee")
                {
                    ...
                    if (roleName.FirstOrDefault() == "employee")
                    {
                        ...
                        {
                            bool isAuthoried = _context.AssignEmployeeRoles.Any(e => e.EmployeeId == employee.EmployeeId && e.EmployeeRoleId == (int)EmpRoles.ProcessingRequests);
                            if (isAuthoried)
                            {
                                aleadyAuthorized = true;
                            }
        ...
        public async Task<JsonResult> OnPostAsync()
        {
            ...
            var recordsTotal = _context.Requests.Where(e => e.IsDeleted == false && e.VisaRequestStatusId == 2).Count();
            ...
            var customersQuery = _context.Requests.Include(e => e.Country).Include(e => e.VisaRequestStatus).Include(e => e.Nationality).Include(e => e.ManoEntityType).Include(e => e.CompanyMarkting).Include(e => e.Employee).Where(e => e.IsDeleted == false && e.VisaRequestStatusId == 2).Select(i => new
            {
        ...
        public async Task<IActionResult> OnPostAssignRequest()
        {
            ...
            try
            {
                ...
                _toastNotification.AddSuccessToastMessage("Employee Re Assigned To Request successfully");
