...
namespace ManoTourism.Areas.Admin.Pages.ManageRequests
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<JsonResult> OnPostAsync()
        {
            ...
            var recordsTotal = _context.Requests.Where(e => e.IsDeleted == false).Count();
            ...
            var customersQuery = _context.Requests.Include(e => e.Country).Include(e => e.VisaRequestStatus).Include(e => e.Nationality).Include(e => e.ManoEntityType).Include(e => e.CompanyMarkting).Where(e => e.IsDeleted == false).Select(i => new
            {
                RequestId = i.RequestId,
                //RequestDate = i.RequestDate.ToString("dddd, dd MMMM yyyy"),
                RequestDate = i.RequestDate.Date,
