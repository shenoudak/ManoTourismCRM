...
namespace ManoTourism.Areas.Admin.Pages.ManageToursOutUAE
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<JsonResult> OnPostAsync()
        {
            ...
            var recordsTotal = _context.Trips.Where(e => e.IsDeleted == false && e.TripTargetId == 2).Count();

            var customersQuery = _context.Trips.Include(e => e.Country).Include(e => e.TripType).Where(e => e.IsDeleted == false && e.TripTargetId == 2).Select(i => new
            {
