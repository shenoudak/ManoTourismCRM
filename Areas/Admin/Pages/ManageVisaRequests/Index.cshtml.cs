...
namespace ManoTourism.Areas.Admin.Pages.ManageVisaRequests
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<JsonResult> OnPostAsync()
        {
            ...
            var recordsTotal = _context.Requests.Where(e => e.IsDeleted == false&&e.EntityId==staticVisaId&& e.ManoEntityTypeId == 1).Count();
            ...
            var customersQuery = _context.Requests.Include(e => e.Country).Include(e => e.VisaRequestStatus).Include(e => e.Nationality).Include(e => e.ManoEntityType).Include(e => e.CompanyMarkting).Where(e => e.IsDeleted == false && e.EntityId == staticVisaId && e.ManoEntityTypeId == 1).Select(i => new
            {
