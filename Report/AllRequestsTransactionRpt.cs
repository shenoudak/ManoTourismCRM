...
{
    public partial class AllRequestsTransactionRpt : DevExpress.XtraReports.UI.XtraReport
    {
        //public IRequestCultureFeature locale;
        public string BrowserCulture;
        public AllRequestsTransactionRpt(string language)
        {
        ...
        private void EmployeeReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            else
            {
                ...
                invoiceLabel.Text = " تقرير كامل لكل الطلبات";
                thankYouLabel.Text = "مانو للسياحه";
                xrTableCell3.Text = "الموظف المشارك";
                xrTableCell5.Text = "تاريخ الطلب";
